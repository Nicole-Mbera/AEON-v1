              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  {student.profile_picture ? (
                    ...
                    <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[gray-300] to-[gray-400] flex items-center justify-center text-white font-bold text-2xl shadow-lg">
