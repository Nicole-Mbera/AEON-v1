          ...
          {data.upcomingConsultations.length === 0 ? (
            ...
            <div className="space-y-3">
              {data.upcomingConsultations.map((session) => (
                <div
                  key={session.id}
                  className="flex items-start gap-4 rounded-xl border border-[gray-200]/50 bg-white p-4 transition-all hover:border-[gray-300] hover:shadow-md"
                >
                  <div className="flex h-14 w-14 flex-col items-center justify-center rounded-lg bg-[gray-300]/10 text-center shrink-0">
